.PHONY: start stop restart status logs down shutdown
...
stop:
	@echo "Stopping services on ports $(RUNNER_PORT), $(CRUD_PORT), $(MGMT_PORT)..."
...
start: logs
	...
	@nohup $(PYTHON) ui-managementstudio/app.py > logs/ui-mgmt.log 2>&1 &
